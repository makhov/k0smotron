...
func (in *AutoscalingSpec) DeepCopyInto(out *AutoscalingSpec) {
	*out = *in
	if in.HorizontalPodAutoscaling != nil {
		...
		*out = new(HorizontalPodAutoscalingSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HorizontalPodAutoscalingSpec) DeepCopyInto(out *HorizontalPodAutoscalingSpec) {
	*out = *in
	if in.Metrics != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HorizontalPodAutoscalingSpec.
func (in *HorizontalPodAutoscalingSpec) DeepCopy() *HorizontalPodAutoscalingSpec {
	if in == nil {
		return nil
	}
	out := new(HorizontalPodAutoscalingSpec)
